namespace :cron_task do
  ...
  namespace :continuous do
    ...
    desc "*/1 * * * * cd /mnt/company-api/current && rake RAILS_ENV=staging cron_task:continuous:process_email_service_api_call_hooks lock_key_suffix=1 >> /mnt/company-api/shared/log/process_email_service_api_call_hooks.log"
